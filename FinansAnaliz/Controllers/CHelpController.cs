...
{
    public class CHelpController : Controller
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly UserManager<IdentityUser> _userManager;
        private readonly AppDbContext _appDbContext;
        public CHelpController(AppDbContext appDbContext, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager)
        {
        ...
        public async Task<IActionResult> NewHelp(Help model)
        {
            ...
            ViewBag.HelpList = HelpList;
            return RedirectToAction("Index", "CHelp");
        }
    }
}
